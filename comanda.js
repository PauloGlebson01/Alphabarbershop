...
<head>
    ...
    <title>Comanda #${numeroComanda} - Alpha BarberShop</title>
    <style>
...
<body>
    <div class="documento" id="documentoImprimir">
        <div class="header">
            <div class="logo-text">Alpha <span>Barbershop</span></div>
            <div class="subtitulo">💈 Mais que corte. Ritual do Reflexo</div>
